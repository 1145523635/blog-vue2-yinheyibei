 ...
 * @LastEditors: 银河以北
 * @LastEditTime: 2021-09-15 13:30:26
-->
<template>
      ...
      <el-row :gutter="50">
        ...
        <el-col :span="7" :xs="24" :sm="24" :md="7"
          ><div class="introduce">
            ...
            <div class="logo-title" @click="toHme"><h2>银河以北</h2></div>
            <div>
              <p>
          ...
          ><div class="blog-link">
            <div>
              ...
              <div class="icon-container">
                <svg-icon icon-class="QQ" class="svg-icon" @click="toQQ" />
                <el-popover placement="top" width="100" trigger="hover">
                  <img :src="author" width="100%" alt="" />
                  <svg-icon
                    icon-class="WeChat"
                    class="svg-icon"
                    slot="reference"
        ...
        <el-col :span="7" :xs="24" :sm="24" :md="7"
          ><div class="technical-support">
            <h3>技术支持</h3>
            <p>
              <el-tag effect="dark" type="success" size="mini" class="item"
                >vue2</el-tag
              >
              <el-tag effect="dark" type="info" size="mini" class="item"
                >thinkphp6</el-tag
              >
              <el-tag effect="dark" type="warning" size="mini" class="item"
                >mysql</el-tag
              >
              <el-tag effect="dark" type="" size="mini" class="item"
                >element-ui</el-tag
              >
              <el-tag effect="dark" type="danger" size="mini" class="item"
                >redis</el-tag
              >
            </p>
          </div></el-col
